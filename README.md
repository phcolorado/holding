...
- **Painéis gráficos** (`/financeiro/paineis/`): ocupação/vacância histórica das unidades locáveis, receitas × despesas por imóvel, inadimplência em aberto por competência e despesas por categoria — com filtro de período (6/12/24 meses) e tabela acessível em cada gráfico
